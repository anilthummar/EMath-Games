  ...
  void init(
    ...
    unawaited(runZonedGuarded(() async {
      ...
      FlutterError.onError = (FlutterErrorDetails details) {
        ...
        if (getIt.isRegistered<CrashlyticsHandler>()) {
          unawaited(getIt<CrashlyticsHandler>().recordFlutterError(details));
        }
      ...
      if (getIt.isRegistered<CrashlyticsHandler>()) {
        await getIt<CrashlyticsHandler>().recordError(exception, stackTrace);
      }
  ...
  FutureOr<void> _initServices() async {
    try {
      ...
      await SentryService.instance.init(
        SentryConfig(
          dsn: configSentryDSN,
          userId: AppConstant.sentryUserId,
          userEmail: AppConstant.sentryUserEmail,
        ),
      );
