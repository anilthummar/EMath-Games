...
class ForceUpdateUnderMaintenanceBloc
  ...
  Future<ForceUpdateConfigModel?> readRemoteConfig() async {
    try {
      ...
      final String config = getIt<RemoteConfigService>().getForceUpdateConfig();
      if (config.isNotEmpty) {
        return ForceUpdateConfigModel.fromJson(jsonDecode(config));
      }
    } on Exception catch (e) {
      DebugLog.instance.e('Error fetching remote config: $e');
    }
    return null;
  }
  ...
  Future<void> openPlayStoreAppStore() async {
    ...
    try {
      ...
      DebugLog.instance.e('Error launching store: $e');
    }
  }
