...
abstract class $SettingsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({BaseStateStatus status, SettingsModel settings});
...
class _$SettingsStateImpl
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'SettingsState(status: $status, settings: $settings)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, status, settings);
...
abstract class _SettingsState implements SettingsState {
  const factory _SettingsState(
      {final BaseStateStatus status,
      final SettingsModel settings}) = _$SettingsStateImpl;
