...
abstract class $SettingsModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String languageCode, bool isSoundEnabled});
}
...
class _$SettingsModelImpl
  ...
  const _$SettingsModelImpl(
      {this.languageCode = AppConstant.en, this.isSoundEnabled = true});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'SettingsModel(languageCode: $languageCode, isSoundEnabled: $isSoundEnabled)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('isSoundEnabled', isSoundEnabled));
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, languageCode, isSoundEnabled);
...
abstract class _SettingsModel implements SettingsModel {
  const factory _SettingsModel(
      {final String languageCode,
      final bool isSoundEnabled}) = _$SettingsModelImpl;
