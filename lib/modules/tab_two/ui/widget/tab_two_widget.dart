      ...
      children: <Widget>[
        GestureDetector(
            ...
            child: CustomTextLabelWidget(
                label: context.appStrings.detailPageWithOutBottomBarKey)),
        const SizedBox(
          height: Dimens.space10,
        ),
        CustomTextLabelWidget(label: context.appStrings.changeLanguageKey),
        const SizedBox(
          height: Dimens.space10,
        ),
        CustomButtonWidget(
            ...
            text: context.appStrings.englishKey),
        const SizedBox(
          height: Dimens.space10,
        ),
        CustomButtonWidget(
            ...
            width: Dimens.size200,
            text: context.appStrings.hindiKey),
      ],
    );
  }
}
